...
class CustomerDetail {
    ...
    custBalance;
    custAccountNum;
    constructor(custFirst, custLast, custGender, custAge, custMobile, custBalance, custAccountNum) {
...
async function addCustomer() {
    ...
    const customer = new CustomerDetail(answers.custFirstName, answers.custLastName, answers.custGender, parseInt(answers.custAge), answers.custMobile, parseFloat(answers.custBalance), CustomerDetail.generateAccountNumber());
